...
if __name__ == "__main__":
    ...
    if args.method != "plan":
        ...
        gen_paths = model.sample(args.eval_num, args.batch_traj_num, real_paths=real_paths, bool_prefix=args.bool_prefix, ret_org=args.ret_org, fix_length=args.fix_length)
